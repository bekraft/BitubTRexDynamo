...
public class IfcAuthorMetadata
{
    ...
    private IfcAuthorMetadata(IfcAuthoringMetadata? authoringMetadata = null)
    {
        MetaData = authoringMetadata;
    }

    internal IfcAuthoringMetadata? MetaData { get; private init; }
    ...
    {
        if (ifcModel is { IsCanceled: false })
    ...
    /// <summary>
    /// Create a new IFC project metadata by given credentials
    /// </summary>
    ...
    /// <returns>New metadata wrapping author's credentials and organisation details</returns>        
