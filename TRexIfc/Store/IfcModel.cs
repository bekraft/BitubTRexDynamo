...
public class IfcModel : ProgressingModelTask<IfcModel>
{
    ...
    internal IModel? XbimModel => IsCanceled ? null : Store.XbimModel;
    ...
    /// <inheritdoc/>
    /// </summary>
    public new string CanonicalFileName(string separator = "-")
    {
        return base.CanonicalFileName(separator);
    }

    /// <summary>
    /// <inheritdoc/>
    /// </summary>
    public new string CanonicalName(string separator = "-")
    {
        return base.CanonicalName(separator);
    }
...
#pragma warning restore CS1591
    ...
    /// The project name.
    /// </summary>
    public string? ProjectName => XbimModel?.Instances.FirstOrDefault<IIfcProject>()?.Name;
