...
public abstract class ProgressingModelTask<TModel> : ProgressingTask
{
    ...
    private static Qualifier BuildQualifier(params string[] pathNameFileNameAndExtension)
    {
        var name = new Name();
    ...
    /// </summary>
    protected internal bool IsTemporaryModel => Qualifier.GuidOrNameCase != Qualifier.GuidOrNameOneofCase.Named;
